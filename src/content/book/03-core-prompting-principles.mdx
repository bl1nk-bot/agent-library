...
<Compare
  ...
  after={{
    label: "Precise",
    content: "Summarize in exactly 3 bullet points, each under 20 words.",
  }}
/>
...
<SpecificitySpectrum
  levels={[
    ...
    {
      level: "Level 3",
      text: "Write a 500-word article about how climate change affects coral reefs",
    },
    {
      level: "Level 4",
      text: "Write a 500-word article explaining how rising ocean temperatures cause coral bleaching, aimed at high school students, with 2 specific examples from the Great Barrier Reef, in an engaging but scientifically accurate tone",
    },
  ]}
/>
  ...
  items={[
    {
      ...
      description: "Is your prompt explicit and unambiguous?",
    },
    {
      id: "specificity",
      label: "Specificity Yields Quality",
      description: "Have you included audience, length, tone, and format?",
    },
    {
      id: "context",
      label: "Context Is King",
      description: "Does the prompt include all necessary background information?",
    },
    {
      id: "examples",
      label: "Examples Beat Explanations",
      description: "Have you shown what you want, not just described it?",
    },
    {
      id: "constraints",
      label: "Constraints Focus Output",
      description: "Are there clear boundaries on scope and format?",
    },
    {
      id: "iteration",
      label: "Iterate and Refine",
      description: "Are you prepared to improve based on results?",
    },
    {
      id: "persona",
      label: "Persona Shapes Perspective",
      description: "Does the AI know what role to play?",
    },
    {
      id: "verify",
      label: "Verify and Validate",
      description: "Have you built in checks for accuracy?",
    },
  ]}
/>
