<Section>
  <Panel character="promi" mood="excited">
    다시 만나서 반가워요! 오늘 수업은 **언제**와 **어디서** - 이 세부사항들이 프롬프트에 생명을
    불어넣어요!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="thinking">
    "고양이에 대한 이야기"는 괜찮지만, "무서운 할로윈 밤의 고양이에 대한 이야기"는 훨씬 더
    흥미로워요!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  훌륭한 작업이에요! 이제 프롬프트에 **언제**(시간)와 **어디서**(장소)를 추가하는 방법을 알아요.
  이게 요청을 훨씬 더 흥미롭게 만들어요!
</Panel>
