<Section>
  <Panel character="promi" mood="excited">
    **창의력 협곡**에 오신 것을 환영해요! 🎨 여기는 창의력이 살아나는 곳이에요! 오늘은 **역할극
    프롬프트**에 대해 배워요!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="happy">
    역할을 맡아달라고 하면, 그 캐릭터의 목소리와 스타일로 대답할 수 있어요! 함께 상상 놀이를 하는 것
    같아요!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  환상적이에요! **역할극 프롬프트**가 대화를 창의적이고 재미있게 만든다는 것을 배웠어요! "인
  척해줘"나 "가 돼줘"라고만 요청하면 돼요!
</Panel>
