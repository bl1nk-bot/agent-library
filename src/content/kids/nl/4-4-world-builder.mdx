<Section>
  <Panel character="promi" mood="excited">
    Welkom bij het laatste level van de Creatiecanyon! 🎨 Laten we **Wereldbouwers** worden en
    geweldige fantasiescenario's maken!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Je hebt het gedaan! Je hebt de Creatiecanyon voltooid en bent een **Wereldbouwer** geworden! Je
  verbeelding gecombineerd met AI kan eindeloos geweldige werelden maken!
</Panel>
