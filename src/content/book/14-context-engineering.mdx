...
<Callout type="info" title="Why Context Matters">
  AI models are stateless. They don't remember past conversations. Every time you send a message,
  you need to include everything the AI needs to know. This is called "context engineering."
</Callout>
...
<Callout type="warning" title="Important Concept">
  AI doesn't remember anything between conversations. Every API call starts fresh. If you want the
  AI to "remember" something, YOU have to include it in the context every time.
</Callout>
...
<div className="bg-muted/30 my-6 rounded-lg border p-4">
  <p className="mb-3 font-semibold">How RAG Works:</p>
  <div className="flex flex-col gap-2 text-sm">
    <div className="flex items-center gap-3">
      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 font-bold text-blue-600 dark:bg-blue-900">
        1
      </span>
    ...
    <div className="flex items-center gap-3">
      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 font-bold text-green-600 dark:bg-green-900">
        5
      </span>
...
<div className="my-6 grid gap-4 md:grid-cols-2">
  <div className="rounded-lg border p-4">
    <p className="mb-2 flex items-center gap-2 font-semibold text-green-600 dark:text-green-400">
      <IconCheck className="text-green-600" /> RAG Advantages
    </p>
  ...
  <div className="rounded-lg border p-4">
    <p className="mb-2 flex items-center gap-2 font-semibold text-amber-600 dark:text-amber-400">
      <IconLightbulb className="text-amber-600" /> When to Use RAG
    </p>
    <ul className="text-muted-foreground space-y-1 text-sm">
...
<Callout type="tip" title="Also Called">
  Different AI providers call this different things: "function calling" (OpenAI), "tool use"
  (Anthropic/Claude), or "tools" (general term). They all mean the same thing.
</Callout>
...
<Callout type="info" title="prompts.chat Uses MCP">
  This platform has an MCP server! You can connect it to Claude Desktop or other MCP-compatible
  clients to search and use prompts directly from your AI assistant.
</Callout>
...
<Callout type="tip" title="Remember">
  The quality of AI output depends on the quality of context you provide. Better context = better
  answers.
</Callout>
