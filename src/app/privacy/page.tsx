      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            prompts. All prompts shared on this platform are released under the{" "}
            <Link
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">When you use the platform, we collect:</p>
          <ul className="text-muted-foreground list-inside list-disc space-y-1">
            <li>Prompts you create and share</li>
            <li>Categories and tags you assign to prompts</li>
            <li>
              Analytics data through Google Analytics to understand usage patterns (can be disabled
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            We monitor account activity to maintain platform quality and prevent abuse. If unusual
            or abusive activity is detected, your account may be flagged. This information is stored
          ...
          <p className="text-muted-foreground mt-3">
            Flagged accounts are subject to restrictions including a daily limit of 5 prompts and
            automatic unlisting of new prompts. This data is only visible to administrators and is
            used solely for platform integrity purposes.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            Analytics to understand how the service is used, including tracking events such as
            prompt views, searches, and interactions. On self-hosted instances, analytics can be
            disabled by not setting the
            <code className="bg-muted rounded px-1 py-0.5 text-xs">GOOGLE_ANALYTICS_ID</code>{" "}
        ...
        <section className="space-y-3">
          ...
          <ul className="text-muted-foreground list-inside list-disc space-y-1">
            ...
            <li>
              Download any prompts directly from the platform (all prompts are CC0 and publicly
              available)
            </li>
          </ul>
          <p className="text-muted-foreground mt-3">
            <strong>Important:</strong> Because all prompts are released under the CC0 license and
            belong to the public domain, they cannot be deleted or removed once published. This is
            by design—CC0 content is free for anyone to use, modify, and distribute without
            restriction. Account deletion does not remove prompts you have contributed, as they are
