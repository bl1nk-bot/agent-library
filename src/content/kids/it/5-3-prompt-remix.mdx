<Section>
  <Panel character="promi" mood="excited">
    Oggi impariamo il **Remix dei Prompt**! 🎵 Questo significa cambiare i prompt per ottenere
    risultati diversi!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Fantastico! Hai imparato a **remixare i prompt** per ottenere risultati diversi dallo stesso
  argomento! Questo rende la tua creatività infinita!
</Panel>
