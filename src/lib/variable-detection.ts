...
// 🛡️ Guardian: Consolidated from src/pages/api/mcp.ts
// This function was duplicated in MCP API - moved to canonical location
// JULES Check: Verified no Autonomous task conflicts
// Impact: 2 → 1 file implementation, extracted to variable-detection
// Date: 2026-07-09
