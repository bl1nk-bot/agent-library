...
<Callout type="info" title="AI as Writing Partner">
  AI works best as a collaborative writing tool—use it to generate drafts, then refine with your
  expertise and voice.
</Callout>
...
<Callout type="tip" title="Marketing Copy Principle">
  Focus on **benefits over features**. Instead of "Our software uses AI algorithms," write "Save 10
  hours a week with automated reports." Show readers how their lives improve.
</Callout>
...
<Callout type="info" title="Technical Writing Principle">
  **Clarity over cleverness.** Use simple words, short sentences, and active voice. Every sentence
  should have one job. If readers have to re-read something, simplify it.
</Callout>
...
<Callout type="tip" title="Key Techniques">
  Specify audience and purpose clearly, define structure and format, include style guidelines,
  provide examples when possible, and request specific deliverables.
</Callout>
