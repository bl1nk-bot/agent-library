...
export default function SelfHostingPage() {
  return (
    <div className="container max-w-4xl py-10">
      <h1 className="mb-2 text-2xl font-bold">Self-Hosting Guide</h1>
      <p className="text-muted-foreground mb-8">
        Deploy your own prompts.chat instance with customizable branding, themes, and
        authentication.
      </p>
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-10">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted space-y-1 overflow-x-auto rounded-lg p-4 font-mono text-sm">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Create a <code className="bg-muted rounded px-1.5 py-0.5 text-sm">.env</code> file
              based on <code className="bg-muted rounded px-1.5 py-0.5 text-sm">.env.example</code>:
            </p>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        PostgreSQL connection string. Add{" "}
                        <code className="text-xs">?connection_limit=5&pool_timeout=10</code> for
                        serverless.
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        Your app URL (e.g., <code className="text-xs">http://localhost:3000</code>)
                      </TableCell>
                    </TableRow>
                    <TableRow>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        <code className="text-xs">url</code> | <code className="text-xs">s3</code> |{" "}
                        <code className="text-xs">do-spaces</code>
                      </TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        DigitalOcean Spaces: BUCKET, REGION, ACCESS_KEY_ID, SECRET_ACCESS_KEY,
                        CDN_ENDPOINT
                      </TableCell>
                    </TableRow>
                  </TableBody>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        OpenAI API key for AI search and generation
                      </TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        ...
                        <code className="text-xs">text-embedding-3-small</code>)
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-mono text-xs">OPENAI_GENERATIVE_MODEL</TableCell>
                      <TableCell className="text-muted-foreground text-sm">
                        Generative model (default: <code className="text-xs">gpt-4o-mini</code>)
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        ...
                        <code className="text-xs">G-XXXXXXXXX</code>)
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Customize your instance by editing{" "}
              <code className="bg-muted rounded px-1.5 py-0.5 text-sm">prompts.config.ts</code>:
            </p>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        Your app name displayed in header and footer
                      </TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-xs">string</TableCell>
                      <TableCell className="text-muted-foreground text-sm">
                        App description for SEO and homepage
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-xs">
                        <code>flat</code> | <code>default</code> | <code>brutal</code>
                      </TableCell>
                      <TableCell className="text-muted-foreground text-sm">
                        UI style variant
                      </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        Primary brand color (e.g., <code>#6366f1</code>)
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        <code>credentials</code>, <code>github</code>, <code>google</code>,{" "}
                        <code>azure</code>
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-sm">
                        Allow public sign-up (credentials provider only)
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-xs">string[]</TableCell>
                      <TableCell className="text-muted-foreground text-sm">
                        Supported locales: en, tr, es, zh, ja, ar, pt, fr, it, de, ko
                      </TableCell>
                    </TableRow>
                    <TableRow>
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-xs">true</TableCell>
                      <TableCell className="text-muted-foreground text-sm">
                        Enable version control with change requests
                      </TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-muted-foreground text-xs">false</TableCell>
                      <TableCell className="text-muted-foreground text-sm">
                        AI-powered generation features (requires OPENAI_API_KEY)
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Deploy to Vercel, Railway, Render, or any Node.js hosting platform. Make sure to set
              all environment variables in your hosting provider&apos;s dashboard.
            </p>
          </div>
