...
<Panel character="promi" mood="thinking">
  Sai cosa significa **IA**? IA sta per **Intelligenza Artificiale**. È un modo elegante per dire
  "un computer che può pensare e parlare"!
</Panel>
...
<Panel character="promi" mood="celebrating">
  Ottimo lavoro! Hai imparato cos'è l'IA e cos'è un prompt. Stai già diventando un esperto di
  prompt!
</Panel>
