<Section>
  <Panel character="promi" mood="excited">
    Welcome to the final level of Clarity Castle! 🏰 You've learned about WHO, WHAT, WHEN, and
    WHERE. Now let's put it ALL together!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  You did it! You've completed Clarity Castle and become a **Detail Detective**! You now know the
  secret: WHO + WHAT + WHEN + WHERE = Amazing Prompts!
</Panel>
