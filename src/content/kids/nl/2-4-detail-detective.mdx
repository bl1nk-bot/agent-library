<Section>
  <Panel character="promi" mood="excited">
    Welkom bij het laatste level van het Duidelijkheidskasteel! 🏰 Je hebt geleerd over WIE, WAT,
    WANNEER en WAAR. Nu gaan we het ALLEMAAL combineren!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="thinking">
    Je hebt niet ALLE vier elke keer nodig, maar hoe meer details je toevoegt, hoe beter ik je kan
    helpen!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Je hebt het gedaan! Je hebt het Duidelijkheidskasteel voltooid en bent een **Detaildetective**
  geworden! Je kent nu het geheim: WIE + WAT + WANNEER + WAAR = Geweldige prompts!
</Panel>
