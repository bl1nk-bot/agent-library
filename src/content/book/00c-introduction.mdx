...
*This book is part of the [Awesome ChatGPT Prompts](https://github.com/bl1nk-bot/agent-library) project and is licensed under CC0 1.0 Universal (Public Domain).*
