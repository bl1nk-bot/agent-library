...
<Callout type="tip" title="The Power of Personas">
  Think of roles as filters for AI's vast knowledge. The right role focuses responses like a lens
  focuses light.
</Callout>
...
<Callout type="info" title="Why This Matters">
  The model isn't pretending or role-playing in a theatrical sense. It's statistically biasing its
  outputs toward patterns it learned from real experts, professionals, and specialists during
  training. A "doctor" role activates medical knowledge pathways; a "poet" role activates literary
  patterns.
</Callout>
...
<div className="my-4 grid gap-2">
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Code review</span>
    <span className="text-muted-foreground">Senior developer + mentor</span>
  </div>
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Writing feedback</span>
    <span className="text-muted-foreground">Editor + target audience member</span>
  </div>
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Business strategy</span>
    <span className="text-muted-foreground">Consultant + industry expert</span>
  </div>
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Learning new topic</span>
    <span className="text-muted-foreground">Patient teacher + practitioner</span>
  </div>
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Creative writing</span>
    <span className="text-muted-foreground">Specific genre author</span>
  </div>
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Technical explanation</span>
    <span className="text-muted-foreground">Expert + communicator</span>
  </div>
  <div className="bg-muted/50 flex gap-2 rounded-lg p-3">
    <span className="min-w-40 font-semibold">Problem-solving</span>
...
<Compare
  before={{
    label: "Problematic",
    content: "You are a creative writer who always follows strict templates.",
  }}
  after={{
    label: "Better",
    content:
...
<Callout type="info" title="Key Takeaways">
  Role-based prompting is powerful because it focuses the model's vast knowledge, sets expectations
  for tone and style, provides implicit context, and makes outputs more consistent.
</Callout>
