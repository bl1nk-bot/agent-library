<Section>
  <Panel character="promi" mood="excited">
    Great to see you again! Today's lesson is about **WHEN** and **WHERE** - these details make your
    prompts come alive!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="thinking">
    "A story about a cat" is okay, but "A story about a cat on a spooky Halloween night" is SO much
    more interesting!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Fantastic work! You now know how to add **WHEN** (time) and **WHERE** (place) to your prompts.
  This makes your requests so much more interesting!
</Panel>
