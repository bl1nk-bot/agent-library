              ...
              <div key={index} className="flex items-start gap-2">
                <div className="flex flex-col">
                  <Button
                    ...
                    disabled={index === 0}
                    className="text-muted-foreground hover:text-foreground focus-visible:ring-agent-cyan h-6 w-6 shrink-0 focus-visible:ring-2 focus-visible:outline-none disabled:opacity-30"
                ...
                <Button
                  ...
                  className="text-muted-foreground hover:text-destructive focus-visible:ring-agent-cyan shrink-0 focus-visible:ring-2 focus-visible:outline-none"
