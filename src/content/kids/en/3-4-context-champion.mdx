<Section>
  <Panel character="promi" mood="excited">
    Welcome to the final level of Context Caves! 🕳️ Time to become a **Context Champion** by
...
<Panel character="promi" mood="celebrating">
  You did it! You've completed Context Caves and become a **Context Champion**! You now know how to
  combine background, examples, and format for amazing prompts!
</Panel>
