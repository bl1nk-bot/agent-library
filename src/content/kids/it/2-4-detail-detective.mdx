<Section>
  <Panel character="promi" mood="excited">
    Benvenuto all'ultimo livello del Castello della Chiarezza! 🏰 Hai imparato CHI, COSA, QUANDO e
    DOVE. Ora mettiamo TUTTO insieme!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Ce l'hai fatta! Hai completato il Castello della Chiarezza e sei diventato un **Detective dei
  Dettagli**! Ora conosci il segreto: CHI + COSA + QUANDO + DOVE = Prompt Incredibili!
</Panel>
