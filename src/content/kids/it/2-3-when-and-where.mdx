<Section>
  <Panel character="promi" mood="excited">
    Bello rivederti! La lezione di oggi è su **QUANDO** e **DOVE** - questi dettagli danno vita ai
    tuoi prompt!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="thinking">
    "Una storia su un gatto" va bene, ma "Una storia su un gatto in una notte spaventosa di
    Halloween" è MOLTO più interessante!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Lavoro fantastico! Ora sai come aggiungere **QUANDO** (tempo) e **DOVE** (luogo) ai tuoi prompt.
  Questo rende le tue richieste molto più interessanti!
</Panel>
