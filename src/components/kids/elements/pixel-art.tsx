...
/** Pixel-art pine tree decoration for the progress map. */
...
/** Pixel-art bush decoration for the progress map. */
...
/** Pixel-art cloud decoration for the progress map. */
...
/** Pixel-art castle decoration used for Clarity Castle world. */
...
/** Pixel-art mountain decoration used for Master Mountain world. */
...
/** Pixel-art flower decoration for the progress map. Accepts an optional hex color. */
...
/** Pixel-art star icon. Pass `filled=true` for a solid gold star (used in star-rating UI). */
...
/** Pixel-art robot character (Promi) with mood-based facial expressions and sparkle effects. */
...
/** Pixel-art level node used on the progress map to show a level's locked/available/completed state. */
...
/** Pixel-art dotted path segment that connects level nodes on the progress map. */
...
/** Pixel-art sports car decoration used on the progress map. Accepts an optional hex color. */
...
/** Pixel-art classic Beetle-style car decoration. Accepts an optional hex color. */
...
/** Pixel-art A-Team-style van decoration with optional text label on the side. */
...
/** Pixel-art lake decoration for the progress map. */
...
/** Pixel-art small pond decoration for the progress map. */
...
/** Pixel-art Cessna-style plane with a trailing text banner, used as a progress map decoration. */
