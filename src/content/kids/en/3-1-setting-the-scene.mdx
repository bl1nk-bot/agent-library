<Section>
  <Panel character="promi" mood="excited">
    Welcome to the **Context Caves**! 🕳️ Here we'll discover the magic of **background
    information**!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="thinking">
    Have you ever told someone a joke, but they didn't laugh because they didn't understand the
    background? Context is like giving someone the backstory!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  You're learning to set the scene! Remember: giving me context helps me understand your situation
