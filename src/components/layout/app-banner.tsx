...
function AppStoreIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="93 90 313 300" fill="currentColor" className={className} aria-hidden="true">
...
export function AppBanner() {
  ...
  return (
    <div className="from-primary/90 to-primary text-primary-foreground bg-gradient-to-r">
