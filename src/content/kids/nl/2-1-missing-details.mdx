<Section>
  <Panel character="promi" mood="excited">
    Welkom bij het **Duidelijkheidskasteel**! 🏰 Ik ben zo blij dat je hier bent! In deze wereld
    leren we de magie van **details**!
  </Panel>
</Section>

<Section>
  <Panel character="promi" mood="thinking">
    Heb je ooit iemand om iets gevraagd, maar begrepen ze niet wat je bedoelde? Dat gebeurt ook bij
    AI!
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="happy">
    De tweede vertelt me **wat** ik moet tekenen (puppy), **wat het doet** (spelen), en **waar**
    (zonnig park). Dat is de kracht van details!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Geweldig werk! Je hebt ontdekt dat **details prompts beter maken**. Vage prompts = verwarde AI.
  Gedetailleerde prompts = geweldige resultaten!
</Panel>
