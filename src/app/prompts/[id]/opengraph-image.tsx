...
export default async function OGImage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const truncatedContent =
    displayContent.length > 400 ? displayContent.slice(0, 400) + "..." : displayContent;
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={config.theme?.colors?.primary || "#6366f1"}
              strokeWidth="2.5"
              strokeLinecap="round"
          ...
          {contributorCount > 0 && (
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: 20, color: "#71717a" }}>+{contributorCount}</span>
            </div>
          )}
        </div>
      </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <span style={{ color: "#71717a", fontSize: 16 }}>@{prompt.author.username}</span>
              </div>
            </div>
          </div>
        </div>
