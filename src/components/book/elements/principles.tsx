...
const principles = [
  {
    ...
    description: "Be explicit and unambiguous",
    color: "blue",
  },
  {
    icon: Target,
    title: "Specificity Yields Quality",
    description: "Details improve outputs",
    color: "green",
  },
  {
    icon: Crown,
  ...
  {
    icon: Compass,
    title: "Guide, Don't Just Ask",
    description: "Structure the reasoning process",
    color: "amber",
  },
  {
    icon: RefreshCw,
    title: "Iterate and Refine",
    description: "Improve through successive attempts",
    color: "pink",
  },
  {
    icon: Sparkles,
    title: "Leverage Strengths",
    description: "Work with model training",
    color: "cyan",
  },
  {
    icon: Ruler,
    title: "Control Structure",
    description: "Request specific formats",
    color: "indigo",
  },
  {
    icon: CheckCircle,
    title: "Verify and Validate",
    description: "Check outputs for accuracy",
    color: "rose",
  },
] as const;
