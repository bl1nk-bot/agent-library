<Section>
  <Panel character="promi" mood="happy">
    Welkom terug! Vandaag leren we een superbelangrijke vaardigheid: **zwakke prompts vinden en
    repareren**! 🔧
  </Panel>
</Section>
...
<Section>
  <Panel character="promi" mood="thinking">
    Leren zwakke prompts te herkennen helpt je betere te schrijven! Het is net als een
    promptdetective zijn!
  </Panel>
</Section>
...
<Panel character="promi" mood="celebrating">
  Uitstekend! Je hebt geleerd zwakke prompts te herkennen en **te repareren** door details, formaat
  en stijl toe te voegen! Deze vaardigheid helpt je voor altijd!
</Panel>
