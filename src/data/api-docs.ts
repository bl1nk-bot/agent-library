    ...
    items: [
      ...
      },
      {
        ...
        params: [
          ...
          {
            name: "options",
            type: "{ description?: string; required?: boolean; defaultValue?: string }",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "method",
        signature:
          "summarize(options?: { maxLength?: number; style?: 'bullet' | 'paragraph' }): any",
        description: "Create a summarization prompt",
        returns: "any",
        params: [
          { name: "options", type: "{ maxLength?: number; style?: 'bullet' | 'paragraph' }" },
        ],
      },
      {
        name: "templates.qa()",
      ...
      },
      {
        ...
        type: "method",
        signature:
          "write(options?: { type?: 'blog' | 'email' | 'essay' | 'story' | 'documentation'; tone?: string }): any",
        description: "Create a writing assistant prompt",
        returns: "any",
        params: [
          {
            name: "options",
            type: "{ type?: 'blog' | 'email' | 'essay' | 'story' | 'documentation'; tone?: string }",
          },
        ],
      },
      {
        ...
        type: "method",
        signature:
          "explain(options?: { level?: 'beginner' | 'intermediate' | 'expert'; useAnalogies?: boolean }): any",
        description: "Create an explanation/teaching prompt",
        returns: "any",
        params: [
          {
            name: "options",
            type: "{ level?: 'beginner' | 'intermediate' | 'expert'; useAnalogies?: boolean }",
          },
        ],
      },
      {
        ...
        type: "method",
        signature:
          "extract(options?: { format?: 'json' | 'csv' | 'table'; fields?: string[] }): any",
        description: "Create a data extraction prompt",
        returns: "any",
        params: [
          { name: "options", type: "{ format?: 'json' | 'csv' | 'table'; fields?: string[] }" },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "method",
        signature:
          "refactor(options?: { goal?: 'readability' | 'performance' | 'maintainability' | 'all'; language?: string }): any",
        description: "Create a code refactoring prompt",
        returns: "any",
        params: [
          {
            name: "options",
            type: "{ goal?: 'readability' | 'performance' | 'maintainability' | 'all'; language?: string }",
          },
        ],
      },
      {
        ...
        type: "method",
        signature:
          "apiDocs(options?: { style?: 'openapi' | 'markdown' | 'jsdoc'; includeExamples?: boolean }): any",
        description: "Create an API documentation prompt",
        returns: "any",
        params: [
          {
            name: "options",
            type: "{ style?: 'openapi' | 'markdown' | 'jsdoc'; includeExamples?: boolean }",
          },
        ],
      },
      {
        ...
        type: "method",
        signature:
          "unitTest(options?: { framework?: string; coverage?: 'basic' | 'comprehensive' }): any",
        description: "Create a unit test generation prompt",
        returns: "any",
        params: [
          { name: "options", type: "{ framework?: string; coverage?: 'basic' | 'comprehensive' }" },
        ],
      },
      {
        ...
        type: "method",
        signature:
          "commitMessage(options?: { style?: 'conventional' | 'simple'; includeBody?: boolean }): any",
        description: "Create a commit message prompt",
        returns: "any",
        params: [
          { name: "options", type: "{ style?: 'conventional' | 'simple'; includeBody?: boolean }" },
        ],
      },
      {
        ...
        type: "method",
        signature:
          "reviewComment(options?: { tone?: 'constructive' | 'direct'; severity?: boolean }): any",
        description: "Create a code review comment prompt",
        returns: "any",
        params: [
          { name: "options", type: "{ tone?: 'constructive' | 'direct'; severity?: boolean }" },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "method",
        signature:
          "sql(options?: { dialect?: 'postgresql' | 'mysql' | 'sqlite' | 'mssql'; optimize?: boolean }): any",
        description: "Create a SQL query prompt",
        returns: "any",
        params: [
          {
            name: "options",
            type: "{ dialect?: 'postgresql' | 'mysql' | 'sqlite' | 'mssql'; optimize?: boolean }",
          },
        ],
      },
    ],
    ...
    items: [
      ...
      },
      {
        ...
        params: [
          ...
          { name: "options", type: "Partial<Omit<VideoAction, 'action'>>" },
        ],
      },
      {
        name: ".actions()",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        returns: "this",
        params: [
          { name: "primary", type: "Mood | string" },
          { name: "secondary", type: "(Mood | string)[]" },
        ],
      },
      {
        name: ".energy()",
      ...
      },
      {
        ...
        returns: "this",
        params: [
          { name: "type", type: "SongSection" },
          { name: "bars", type: "number" },
          { name: "description", type: "string" },
        ],
      },
      {
    ...
    items: [
      ...
      },
      {
        ...
        params: [
          ...
          { name: "options", type: "{ useDefaults?: boolean }" },
        ],
      },
      {
    ...
    items: [
      {
        ...
        params: [
          { name: "content", type: "string" },
          { name: "format", type: "'yaml' | 'json' | 'markdown' | 'text'" },
        ],
      },
      {
        name: "toYaml()",
