...
<Callout type="tip" title="The Building Blocks">
  Think of these components like LEGO bricks. You don't need all of them for every prompt, but
  knowing what's available helps you build exactly what you need.
</Callout>
...
<SpecificitySpectrum
  levels={[
    ...
    {
      level: "Best",
      text: "Edit this essay for grammar and clarity, maintaining the original tone but reducing wordiness by 20%",
    },
  ]}
/>
