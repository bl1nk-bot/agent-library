    ...
    <div className="flex h-full w-full flex-col items-center py-6">
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-white/40 hover:bg-white/5 hover:text-white focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-agent-cyan"
              )}
            >
      ...
      <div className="mt-auto flex w-full flex-col items-center gap-3 px-4">
        <button
          ...
          className="group relative mb-2 rounded-md p-3 text-white/40 transition-all hover:bg-white/5 hover:text-white focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-agent-cyan"
