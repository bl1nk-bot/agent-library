<Section>
  <Panel character="promi" mood="excited">
    Vandaag leren we **Prompt Remix**! 🎵 Dit betekent prompts veranderen om verschillende
...
<Panel character="promi" mood="celebrating">
  Fantastisch! Je hebt geleerd **prompts te remixen** om verschillende resultaten van hetzelfde
  onderwerp te krijgen! Dit maakt je creativiteit eindeloos!
</Panel>
