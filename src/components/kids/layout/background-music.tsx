    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <button
          ...
          className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-all focus-visible:ring-2 focus-visible:ring-[#8B4513] focus-visible:ring-offset-1 focus-visible:outline-none ${
