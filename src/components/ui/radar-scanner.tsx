...
export function RadarScanner({ className }: { className?: string }) {
  return (
    <div className={cn("relative flex h-64 w-64 items-center justify-center", className)}>
      <svg viewBox="0 0 200 200" className="h-full w-full" data-testid="radar-svg">
        {/* Concentric Circles */}
        <circle
          cx="100"
          cy="100"
        ...
        <g className="animate-[spin_4s_linear_infinite]" style={{ transformOrigin: "center" }}>
          ...
          <circle cx="100" cy="100" r="98" fill="url(#radarGradient)" opacity="0.1" />
          <defs>
      ...
      {/* Central Point */}
      <div className="absolute h-1.5 w-1.5 rounded-full bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.8)]" />
    </div>
  );
}
