...
So I created a simple GitHub repository called [Awesome ChatGPT Prompts](https://github.com/bl1nk-bot/agent-library). I expected maybe a few hundred people would find it useful.
